...
from libs.network import version, verCode
from libs.encryption import CatAndMouseGame
...
def set_latest_assets():
    ...
    ver_code_ = verCode.get_latest_verCode()
...
httpheader = {
    ...
    'User-Agent': 'Dalvik/2.1.0 (Linux; U; Android 11; Pixel 5 Build/RD1A.201105.003.A1) ',
